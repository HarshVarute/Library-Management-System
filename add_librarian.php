           ...
           if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                if($conn->connect_error){
                    ...
                    if($result->num_rows == 0){
                        ...
                        $conn -> query("INSERT INTO librarian(l_name, l_address, l_email, l_contact, l_password) VALUES ('$_POST[full_name]', '$_POST[address]', '$_POST[email]', '$_POST[contact]', '$_POST[email]')");
