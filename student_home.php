	...
	<div id="main_box">
		   ...
		   <table style="border:none; width:100%;" >
			  ...
			  <?php
                ...
                if ($conn->connect_error) {
                    ...
                    $sql = "SELECT  std_id, book_id, issue_date, due_date, return_date FROM issue WHERE std_id ='".$uniqueid."'";
                    if ($result = $conn->query($sql)) {
                        if ($result->num_rows > 0) {
                            echo "<table class='counter'><tr><th>ID</th><th>Book</th><th>Issue Date</th><th>Due Date</th><th>return Date</th></tr>";
                            // output data of each row
                            while($row = $result->fetch_assoc()) {                           	
                                echo "<tr><td>" . $row["std_id"]. "</td><td>" . $row["book_id"]. "</td><td>" . $row["issue_date"]. "</td><td>" . $row["due_date"]. "</td><td>" . $row["return_date"]. "</td></tr>";
        ...
        <div id="contact" style="display: none;">
	  	...
	  	<div id="about" style="display: none;">
	  		<h1 class="sub_header">About This Web application</h1>
	  		<P id = "about">write your information</P>
	  	</div>
